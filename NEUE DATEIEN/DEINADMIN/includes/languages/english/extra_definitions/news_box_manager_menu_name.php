 ...
 * @version $Id: news_box_manager_menu_names.php 2024-02-16 08:35:16Z webchills $
 */
...
if (file_exists(DIR_FS_CATALOG . DIR_WS_LANGUAGES . $_SESSION['language'] . '/extra_definitions/' . $template_dir . $nbm_language_file)) {
    ...
    $nbm_language_file = DIR_FS_CATALOG . DIR_WS_LANGUAGES . 'german/extra_definitions' . $nbm_language_file;
}
