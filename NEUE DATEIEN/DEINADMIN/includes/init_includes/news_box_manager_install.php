...
('Datumsformat im Newsarchiv', 'NEWS_BOX_DATE_FORMAT', 'short = 07.06.2022<br/>long = Dienstag, 07. Juni 2022', 43),
('Länge des Newsinhalts auf der Startseite', 'NEWS_BOX_CONTENT_LENGTH_CENTERBOX', '0 = gar nicht anzeigen<br/>-1 = kompletter HTML Inhalt wird angezeigt<br/>Anderer Wert = Maximale Anzahl der Zeichen wobei HTML ausgefiltert wird', 43),
('Länge des Newsinhalts im Newsarchiv', 'NEWS_BOX_CONTENT_LENGTH_ARCHIVE', '0 = gar nicht anzeigen<br/>-1 = kompletter HTML Inhalt wird angezeigt<br/>Anderer Wert = Maximale Anzahl der Zeichen wobei HTML ausgefiltert wird', 43)");
