...
* @version $Id: tpL_all_articles_default.php 2022-06-07 08:35816Z webchills $
*/
?>
<div class="centerColumn" id="allArticlesDefault">
    <h1><?php echo sprintf(HEADING_TITLE, $news_type_name); ?></h1>
<?php
if (count($news) == 0) {
?>
    <div id="no-news"><p><?php echo TEXT_NO_NEWS_CURRENTLY; ?></p></div>
<?php
} else {
...
?>
    <div class="news-article <?php echo $article_class; ?>">
        <h2><a href="<?php echo zen_href_link(FILENAME_ARTICLE, "p=$news_id"); ?>"><?php echo $news_item['title']; ?></a></h2>
        <div class="news-dates"><?php echo $news_dates; ?></div>
        <div class="news-content"><?php echo $news_item['news_content']; ?></div>
    </div>
<?php
        }
?>
