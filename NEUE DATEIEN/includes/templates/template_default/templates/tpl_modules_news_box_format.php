...
* @version $Id: tpL_modules_news_box_format.php 2022-06-08 14:59:10Z webchills $
*/
            ...
            foreach ($news as $news_id => $news_item) {
                ...
                $list_box_contents[$row][$col] = array(
                    ...
                    'text' => 
                        ...
                        '        <div class="nb-more nb-forward"><a href="' . zen_href_link(FILENAME_ALL_ARTICLES, 't=' . $news_item['type']) . '">' . NEWS_BOX_SEE_ALL . '</a></div>' . PHP_EOL .
                        '    </div>' . PHP_EOL .
